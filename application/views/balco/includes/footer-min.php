 <script src="<?php echo base_url();?>piadmin/js/lib/jquery/jquery.min.js"></script>
    ...
    <!--<script src="<?php echo base_url();?>piadmin/js/lib/chart-amchart/export.min.js"></script>-->
    ...
    <!--<script src="<?php echo base_url();?>piadmin/js/lib/chart-amchart/brown.js"></script>-->
    ...
    <!--<script src="<?php echo base_url();?>piadmin/js/lib/chart-amchart/amchart-init.js"></script>-->
    <!--Custom JavaScript -->
